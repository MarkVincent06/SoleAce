...
<head>
   ...
   <title>SoleAce - Add Product</title>
</head>
                  ...
                  <div class="card-body">
                     <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-2">
                           <div class="col-md-6">
                                 ...
                                 <select class="form-select form-control @error('category') is-invalid @enderror" name="category" id="category">
                                    ...
                                    <option value="kid" {{ old('category') == 'kid' ? 'selected' : '' }}>Kid's Shoes</option>
                                 </select>
                                 @error('category')
                           ...
                           <div class="col-md-6">
                                 ...
                                 <select class="form-select form-control @error('subcategory_id') is-invalid @enderror" name="subcategory_id" id="subcategory" disabled>
                        ...
                        <div class="col-md-12 mb-2">
                           ...
                           <textarea rows="3" class="form-control @error('small-description') is-invalid @enderror" id="small-description" name="small-description" placeholder="Enter small description">{{ old('small-description') }}</textarea>
                        ...
                        <div class="col-md-12 mb-2">
                           ...
                           <textarea rows="3" class="form-control @error('description') is-invalid @enderror" id="description" name="description" placeholder="Enter description">{{ old('description') }}</textarea>
                           @error('description')
                                 <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                 </span>
                        ...
                        <div class="row mb-2">
                           <div class="col-md-6">
                                 ...
                                 <input type="text" class="form-control @error('original-price') is-invalid @enderror" id="original-price" name="original-price" value="{{ old('original-price') }}" placeholder="Enter original price">
                           ...
                           <div class="col-md-6">
                                 ...
                                 <input type="text" class="form-control @error('selling-price') is-invalid @enderror" id="selling-price" name="selling-price" value="{{ old('selling-price') }}" placeholder="Enter selling price">
                                 @error('selling-price')
                                    <span class="invalid-feedback" role="alert">
                                       <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-12 mb-2">
                           ...
                           <input type="text" class="form-control @error('meta-title') is-invalid @enderror" id="meta-title" name="meta-title" value="{{ old('meta-title') }}" placeholder="Enter meta title">
                           @error('meta-title')
                                 <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                 </span>
                        ...
                        <div class="col-md-12 mb-2">
                           ...
                           <textarea rows="3" class="form-control @error('meta-description') is-invalid @enderror" id="meta-description" name="meta-description" placeholder="Enter meta description">{{ old('meta-description') }}</textarea>
                        ...
                        <div class="col-md-12 mb-2">
                           ...
                           <textarea rows="3" class="form-control @error('meta-keywords') is-invalid @enderror" id="meta-keywords" name="meta-keywords" placeholder="Enter meta keywords">{{ old('meta-keywords') }}</textarea>
                           @error('meta-keywords')
                                 <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                 </span>
